...
<div class="w3-main" style="margin-left:330px;margin-top:53px;">
  ...
  <div class="w3-row-padding w3-margin-bottom w3-light-grey" style="margin-right: 30px;margin-top:20px;">
    ...
    if(isset($_GET['error'])){
      if($_GET['error'] == "invalidmail"){
        echo '<p class="w3-text-red"><p class="w3-text-red">*Invalid Email Address.</p>';
      }
    }
  ...
  <iframe src="../contact.php" style="height:800px;width:100%;border:3px solid black;" title="Iframe Example"></iframe>
